...
//          for german readers/users.
// --------------------------------------------------------------------------
add('English','Englisch');
add('German','Deutsch');
...
add('project id is empty.','Projekt ID ist leer');
add('build ID is empty.','Build ID ist leer');
add('build id not set.','Build ID nicht gesetzt');
...
add('hello','Hallo meine kleine Welt!');
